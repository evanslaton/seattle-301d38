...
function displayPics(){
  ...
  // the variable rando was locally scoped (using let) inside the while loop inside of the displayPics function and therefore cannot be used outside of that while loop's code block.
  console.log(viewed);
