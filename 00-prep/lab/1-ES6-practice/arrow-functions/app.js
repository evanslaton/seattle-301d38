...
// "this" is the joe object created by the Student constructor.
// 2. What is "this" when joe.scopeArrow() is invoked?
// "this" is the window object.
// 3. Explain why "this" is different when an arrow function is used.
// Because the scope of arrow functions bubble up to the nearest non-arrow function scope, when using "this" in an arrow function, it will refer to the nearest non-arrow function scope (which in this case is the window object).
